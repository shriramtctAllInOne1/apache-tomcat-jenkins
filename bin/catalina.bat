...
set "INTEGRATION_SERVICE_HOME=D:/Tomcat_Server/Home_Config/REG_Config/AIS_HOME"
set "DATA_SERVICE_HOME=D:/Tomcat_Server/Home_Config/REG_Config/DATA_SERVICE_HOME"
set "RULES_HOME=D:/Tomcat_Server/Home_Config/REG_Config/RULES_HOME"
set "CACHE_HOME=D:/Tomcat_Server/Home_Config/REG_Config/CACHE_HOME"
set "LOG_HOME=D:\Tomcat_Server\apache-tomcat-reg\logs"

set JAVA_OPTS=%JAVA_OPTS% -DINTEGRATION_SERVICE_HOME="%INTEGRATION_SERVICE_HOME%" -DCACHE_HOME="%CACHE_HOME%" -DLOG4J_HOME="%LOG_HOME%"
set -Dlog4j.configuration="file:%INTEGRATION_SERVICE_HOME%\log4j.properties" -Xms512m -Xmx1024m -XX:PermSize=256m -XX:MaxPermSize=512Mre
